                    ...
                    <form action="{{ route('purchase.update', $purchase->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <x-input id="name" class="block mt-1 w-full" type="text" name="name"
                                :value="$purchase->name " x-model="name" required autofocus />
                        </div>
